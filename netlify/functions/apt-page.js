...
function layout(o) {
  return '<!DOCTYPE html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
    ...
    // Счётчики (Метрика, GA4, Meta Pixel) — до 21.09 SSR-страницы были без них: клики Директа
    // по быстрой ссылке «Все 35 апартаментов» не попадали в Метрику. Ранний inline-старт Метрики
    // (как в index.html) + preconnect, затем общий analytics.js (не переинициализирует счётчик).
    '<link rel="preconnect" href="https://mc.yandex.ru">' +
    '<script>(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)})(window,document,"script","https://mc.yandex.ru/metrika/tag.js","ym");ym(111964874,"init",{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});window.__ulYmInit=true;<\/script>' +
